...
class RopeClimbingScreen(Screen):
    gym_strings = {
    ...
    def __init__(self, **kwargs):
        super(RopeClimbingScreen, self).__init__(**kwargs)
        ...
        button = Button(text="Add Session",
                        ...
                        pos_hint={'center_x': .5, "center_y": .5},
                        size_hint=(0.5, 1))
        button.bind(on_release=self.add_rope_climbing_session)
    ...
    def add_climb(self, instance):
        ...
        self.parent.previous = "rope_climbing"
