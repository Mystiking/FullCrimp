...
from src.StrengthSession import StrengthSession
from custom_kivy.FloatInput import FloatInput
from custom_kivy.TimeInput import TimeInput


class StrengthSessionScreen(Screen):
    def __init__(self, **kwargs):
        super(StrengthSessionScreen, self).__init__(**kwargs)
        ...
        button = Button(text="Add Strength Session",
                        background_color=[0.24, 0.44, 0.40, 1.0],
                        pos_hint={'center_x': .5, "center_y": .5},
                        size_hint=(0.5, 1))
        button.bind(on_release=self.add_strength_session)
    ...
    def add_strength_session(self, instance):
        StrengthSession(duration=self.duration_input_field.to_seconds(),
    ...
    def date_picker_transition(self, instance):
        ...
        self.parent.previous = "strength_session"
